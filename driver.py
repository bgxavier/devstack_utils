...
logando.basicConfig(filename='/opt/stack/tempos.log',level=logando.DEBUG)
...
class LibvirtDriver(driver.ComputeDriver):
	...
	image_time_t = time.time() - image_time
	...
	network_time_t = time.time() - network_time
	spawn_time_t = time.time() - spawn_time

	LOG.debug("Tempos: %s;%s;%s", image_time_t, network_time_t, spawn_time_t)
	...
	LOG.debug("Total time of image creation: %s seconds" % (time.time() - start_time))
